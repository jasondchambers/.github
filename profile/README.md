...
[![](/profile/linkedin_logo.png)](https://www.linkedin.com/in/jasondchambers/) [![](/profile/circleinaspiral_logo.png)](https://circleinaspiral.com/)

### Highlighted Repositories

| Category           | Repo                                                                             | Description                                                                                                                                               |
| ------------------ | -------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AI                 | [MCP Server for Cylera](https://github.com/Cylera/cylera-mcp-server)             | The official MCP Server from Cylera. Brings context about device inventory, threats, risks and utilization powered by the Cylera Partner API into an LLM. |
...
| Development Environment | [mydevenv](https://github.com/jasondchambers/mydevenv)               | Design and philosophy of my preferred dev environment plus dot-files                       |
